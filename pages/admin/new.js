...
const New = () => {
  ...
  const defaultDisco = { name: "", headline: "", organiserID: "", dateStart: "", dateEnd: "", type: "", format: "", sites: [], pictures: [], duration: [], subjects: [], languages: [], persons: [], events: [], periods: [], styles: [], address: { street: "", city: "", postalCode: ""} };
