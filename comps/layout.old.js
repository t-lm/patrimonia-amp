      ...
      <Navbar expand="md" style={{borderBottom:"1px solid #dddddd", padding: "10px 0px", marginTop: 5 }}>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav>
            ...
            {!username && <Nav.Link style={{margin: "0px 20px", color: 'black', fontWeight: 'bold'}} href="/sign">Se connecter</Nav.Link>}
            {username && <Nav.Link style={{margin: "0px 20px", color: 'black', fontWeight: 'bold'}} onClick={() => logout()}>Se deconnecter</Nav.Link>}
